export class PositionService {
   ...
   */
  public positionElements(hostEl: HTMLElement, targetEl: HTMLElement,
    positionStr: string, appendToBody: boolean): { top: number, left: number } {
    ...
    const shiftHeight: KeyAttribute = {
      center: function (): number {
